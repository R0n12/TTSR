...
import utils
import pytorch_ssim
from NAS import TTSR_Search_Space, TTSR_architect
...
def main():
  ...
  # Initialize TTSR_Search_Space super network
  model = TTSR_Search_Space()
  model.cuda()
  # optimizer and scheduler for super network param optimization
  # TODO: optimizer for original TTSR
  # TODO: lr scheduler for TTSR SGD
  optimizer = torch.optim.SGD(model.parameters(), args.learning_rate, momentum=args.momentum, weight_decay=args.weight_decay)
  scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, float(args.epochs), eta_min=args.learning_rate_min)

  architect = TTSR_architect(model, args)
...
# We train TTSR for the first 10 epochs
# we train arch_params and TTSR for epochs >= 10
#TODO: train_queue
#TODO: valid_queue
#TODO: optimizer
#TODO: lr
def train(epoch, train_queue, valid_queue, model, architect, optimizer, lr):
  for step, (input, target) in enumerate(train_queue):
    ...
    if (epoch+1) > 10:
      ...
      #TODO: architect.step func
      architect.step(input_search, target_search, unrolled=args.unrolled)
